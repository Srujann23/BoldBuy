      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
          ...
          <div className="flex flex-col gap-3 lg:flex-row">
            <div onClick={() => setMethod('stripe')} className="flex items-center gap-3 border p-2 px-3 cursor-pointer w-full lg:w-auto">
              <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'stripe' ? 'bg-green-400' : ''}`}></p>
              <div className="flex-shrink-0">
                <img className='h-5 max-w-[80px] w-auto object-contain mx-4' src={assets.stripe_logo} alt="Stripe Logo" />
              </div>
            </div>

            <div onClick={() => setMethod('razorpay')} className="flex items-center gap-3 border p-2 px-3 cursor-pointer w-full lg:w-auto">
              <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'razorpay' ? 'bg-green-400' : ''}`}></p>
              <div className="flex-shrink-0">
                <img className='h-5 max-w-[80px] w-auto object-contain mx-4' src={assets.razorpay_logo} alt="Razorpay Logo" />
              </div>
            </div>

            <div onClick={() => setMethod('cod')} className="flex items-center gap-3 border p-2 px-3 cursor-pointer w-full lg:w-auto">
          ...
          <div className="w-full text-end mt-8">
            <button type='submit' className='bg-black text-white px-16 py-5 text-sm'>PLACE ORDER</button>
          </div>
        </div>
